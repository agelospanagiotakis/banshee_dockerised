...
<p>This application uses encryption to protect the information stored in the database. Your password is the encryption key. In order to retain the encrypted data, your current password is required when changing your password. Recovering your password is therefore not possible.</p>
</xsl:template>
