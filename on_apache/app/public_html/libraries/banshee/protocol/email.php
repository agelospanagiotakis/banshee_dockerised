	...
	class email {
		...
		*/
		public static function valid_address($email) {
			...
			if ($forbidden === null) {
				$settings = "../settings/email_temporary_domains.conf";
				if (file_exists($settings)) {
					$forbidden = file_get_contents($settings);
					$forbidden = explode("\n", $forbidden);
				}
			}
		...
		public function send($to_address = null, $to_name = null) {
			...
			array_push($headers, "User-Agent: Banshee PHP framework e-mail library (https://gitlab.com/hsleisink/banshee/)");
